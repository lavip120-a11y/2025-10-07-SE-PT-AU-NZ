//function returning another function, you can bind the global function variable with the local function variable
...
let addr1 = makeAdder(10);  //10 is copied to the x (function named expression also known as variable refering to a function definition)
console.log(addr1(20));  //20 is copied to the y
