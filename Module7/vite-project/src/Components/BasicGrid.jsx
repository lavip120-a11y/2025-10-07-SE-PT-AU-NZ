...
<CustomCard title="First Column" picture="..\src\assets\383513xlg-Tui.webp">
...
<Grid item xs={2}>middle item</Grid>
<Grid item xs={4}>
<CustomCard title="Last Column" picture="https://mui.com/static/images/cards/contemplative-reptile.jpg">
