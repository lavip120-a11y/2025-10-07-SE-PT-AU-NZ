...
let Models = require("../models"); // just import the folder name and by default index.js will provide the POSTS
...
module.exports = { getPosts, createPost, updatePost, deletePost, getUserPosts };
